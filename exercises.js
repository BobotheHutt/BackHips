...
const MobilityDatabase = {
    ...
    back: {
        catCow: {
            ...
            desc: "Get on your hands and knees. Slowly let your stomach sink down toward the floor while looking up slightly. Then, gently round your spine up toward the ceiling like an arching cat while intellectualizing the movement. Pumps fluid through the spinal column discs.",
            video: "https://healthline.com"
        },
        cobraPress: {
